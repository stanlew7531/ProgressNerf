...
@register_dataloader("chromaAprilDataloader")
class ChromaAprilDataloader(torch.utils.data.Dataset):
    def __init__(self, config: Dict):
        ...
        self.scene_poses = []
        self.scene_segs = []
        for res in glob.glob(os.path.join(self.baseDir, self.datasetType, "rgb", "*.png")):
